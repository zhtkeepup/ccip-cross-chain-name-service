    ...
    OwnerIsCreator
{
    ...
    // https://cll-devrel.gitbook.io/ccip-bootcamp/v/mandarin-ccip-bootcamp/di-2-tian/lian-xi-2-chuang-jian-ni-de-shou-ge-kua-lian-nft
    ...
    // output:
    // Deployer: 0xD2EB0398e8507BC1e324070d1EF329F920Aa0D6e
    // Deployed to: 0x9E142fed29825e6451837852D14E8B6ACa915856
    // Transaction hash: 0xc9df95f6eca09d17fc5bf504f0d0a8e7c824275b5f27c3ed92498a74925e4936
    ...
    // output:
    // Deployed to: 0x46182c7067BbEAFcFF98A79aAAB460f5439db1f7
    constructor(
    ...
    // cast send 0x9E142fed29825e6451837852D14E8B6ACa915856 --rpc-url ethereumSepolia --private-key=$PRIVATE_KEY "enableChain(uint64,address,bytes)" 3478487238524512106 0x46182c7067BbEAFcFF98A79aAAB460f5439db1f7 0x97a657c90000000000000000000000000000000000000000000000000000000000030d40
    // cast send 0x46182c7067BbEAFcFF98A79aAAB460f5439db1f7 --rpc-url arbitrumSepolia --private-key=$PRIVATE_KEY "enableChain(uint64,address,bytes)" 16015286601757825753 0x9E142fed29825e6451837852D14E8B6ACa915856 0x97a657c90000000000000000000000000000000000000000000000000000000000030d40
